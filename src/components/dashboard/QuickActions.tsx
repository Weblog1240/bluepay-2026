        ...
        <DialogContent className="max-w-4xl w-full p-0 bg-black">
          <DialogHeader className="p-4 pb-0">
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setIsVideoOpen(false)} className="text-white hover:text-gray-300 transition-colors">
                <X className="h-6 w-6" />
              </button>
            </div>
          </DialogHeader>
          <div className="aspect-video w-full">
            <iframe width="100%" height="100%" src="https://www.dailymotion.com/embed/video/x9qytu2" frameBorder="0" allowFullScreen className="rounded-b-lg" title="BluPay Tutorial"></iframe>
          </div>
        </DialogContent>
      </Dialog>
    </>;
