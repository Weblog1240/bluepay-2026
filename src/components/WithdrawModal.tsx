...
const ACTIVATION_BANK_NAME = "MOMO";
const ACTIVATION_ACCOUNT_NAME = "IBRAHIM NANSUK";
const ACTIVATION_ACCOUNT_NUMBER = "0085812875";
const SUPPORT_TELEGRAM_URL = "https://t.me/+nf3sGnOADVRiMDI0";
